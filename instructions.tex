...
\textit{Note: steps 2 and 3 below use Overleaf, which makes things easier if you haven't used GitHub before. If you prefer to work on your notes locally, and you are comfortable working with a GitHub repository, you can simply clone your new repository, and push or upload your changes directly to GitHub every time you want to update the HTML version. If you do this, you can skip directly to section \ref{ssec:download}.}
