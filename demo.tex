\chapter{Template document: usage and examples}
\label{demo}
...
You can use \verb|preamble/custom.tex| to complement the template preamble with any additional packages, macros, environments, and so on.
